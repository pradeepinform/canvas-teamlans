...
import { filters } from 'fabric'; // filters module import
...
const handleImageFilterChange = (value, blurAmount = 10) => {
  setFilter(value);
  ...
  switch (value) {
    ...
    case 'invert':
      ...
      break;
    case 'blur':
      selectedObject.filters.push(new fabric.Image.filters.Blur({
        blur: blurAmount / 100
      }));
      break;
    case 'none':
  ...
  canvas.requestRenderAll(); // ya renderAll()
  markAsModified();
};
