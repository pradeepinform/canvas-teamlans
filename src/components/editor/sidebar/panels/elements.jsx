...
import { shapeDefinitions, shapeTypes } from "@/fabric/shapes/shapeDefinitions";
    ...
    try {
      ...
      for (const shapeType of shapeTypes) {
        ...
        try {
          ...
          // ✅ fabric.fabric.StaticCanvas instead of fabric.StaticCanvas
          const miniCanvas = new fabricModule.fabric.StaticCanvas(canvasId, {
            width: 100,
            height: 100,
          ...
          definition.thumbnail(fabricModule.fabric, miniCanvas);
